...
public class Pizzapood {
    public static void main(String[] args) {
        ...
        Jook[] j = {limonaad, vesi, õlu, piim, mahl,
        slimonaad,svesi,sõlu,spiim,smahl};
        ArrayList<Jook> joogid = new ArrayList<>(Arrays.asList(j));
        ...
        Kate[] k = {sai, kaste, juust, hakkliha, salaami, paprika, ananass, seen};
        ArrayList<Kate> katted = new ArrayList<>(Arrays.asList(k));
        Kate[] lihamassiiv = {sai, kaste, juust, hakkliha, paprika};
        Kate[] vorstmassiiv = {sai, kaste, juust, salaami, ananass};
        Kate[] seenemassiiv = {sai, kaste, juust, seen};
        Kate[] suvalinemassiiv = {sai, kaste, juust};
        ...
        Pitsa[] p = {Hakklihapitsa,Salaamipitsa,Šampinjonipitsa,Omalooming,
                sHakklihapitsa,sSalaamipitsa,sŠampinjonipitsa,sOmalooming};
        ArrayList<Pitsa> pitsad = new ArrayList<>(Arrays.asList(p));
        ...
        //while(true) {
            ...
            String tellijaNimi = suhtlus.nextLine();
            ...
            List<Pitsa> tellitudpitsad = new ArrayList<>();
        ...
        System.out.println(tellijaNimi);
        System.out.println(tellitudpitsad);
    }
}
